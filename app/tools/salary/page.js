...
export default function SalaryCalculator() {
  ...
  function calculate() {
    ...
    const calc = calculateNetSalary(value);
    const extra = Number(otherDeductions) || 0;
    setResult({
      ...calc,
      otherDeductions: extra,
      actualTakeHome: calc.net - extra,
    });
  }

  function share() {
    const text = shareLinks.salary;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          OTHER MONTHLY DEDUCTIONS (OPTIONAL)
        </div>
        <div style={{ position: "relative", marginBottom: "16px" }}>
          ...
          <input
            ...
            placeholder="HELB, SACCO, insurance..."
            onChange={(e) => {
        ...
        >
          Include HELB repayments, SACCO contributions, insurance premiums or
          anything deducted from your payslip.
        </div>
        ...
        {result?.belowTax && (
          ...
          >
            ✓ Your salary is below the KES 24,001 PAYE threshold — you pay no
            income tax. NSSF, SHIF and Housing Levy still apply.
          </div>
        )}
            ...
            <div style={{ padding: "16px" }}>
              ...
              <div
                style={{
                  ...
                  padding: "7px 0",
                  borderBottom: "0.5px solid var(--receipt-div)",
                }}
              >
              ...
              {[
                {
                  ...
                  pct: pct(result.paye, result.gross),
                  desc: "KRA income tax",
                },
                {
                  label: "NSSF (pension)",
                  ...
                  pct: pct(result.nssf, result.gross),
                  desc: "Retirement savings",
                },
                {
                  label: "SHIF (health)",
                  value: result.shif,
                  color: "var(--shif-color)",
                  pct: pct(result.shif, result.gross),
                  desc: "2.75% of gross",
                },
                {
                  label: "Housing Levy",
                  value: result.housing,
                  color: "var(--housing-color)",
                  pct: pct(result.housing, result.gross),
                  desc: "1.5% of gross",
                },
              ].map((row) => (
                <div
              ...
              >
                ...
                >
                  − KES {fmt(result.totalDeductions)}
                </span>
              </div>
              ...
              {result.otherDeductions > 0 && (
                ...
                >
                  ...
                  >
                    − KES {fmt(result.otherDeductions)}
                  </span>
                </div>
              )}
              ...
              <div
                style={{
                  ...
                  paddingTop: "14px",
                  marginTop: "4px",
                  borderTop: "1.5px dashed var(--receipt-div)",
                }}
              >
                <div>
                  <div
                  ...
                  >
                    {result.otherDeductions > 0
                      ? `KES ${fmt(result.totalDeductions + result.otherDeductions)} total deducted`
                      : `${result.effectiveRate}% of gross goes to deductions`}
                  </div>
                </div>
                <span
                  style={{
                ...
                >
                  KES {fmt(result.actualTakeHome ?? result.net)}
                </span>
              </div>
        ...
        <div style={{ marginTop: "28px" }}>
          ...
          {showHelp && (
            ...
            >
              ...
              >
                Source: KRA Finance Act 2023 · NSSF Act 4th Schedule Feb 2026 ·
                SHIF Oct 2024
              </div>
            </div>
          )}
        ...
        >
          ...
          HELB loan repayments, SACCO contributions and insurance premiums vary
          per person and employer, they're not included here since they differ
          for everyone.
        </div>
        ...
        >
          Based on KRA Finance Act 2023 · NSSF 4th Schedule · SHIF 2024 ·
          Updated March 2026
        </p>
      </div>
