...
const tools = [
  ...
  },
  {
    ...
    desc: "Compare Safaricom, Zuku, Faiba, Starlink and more — find the best internet for your home and budget.",
    color: "#185FA5",
    bg: "#E6F1FB",
    textColor: "#042C53",
    ready: true,
...
export default function HomePage() {
  return (
    <div>
      ...
      {/* Tools */}
      <section
        style={{ maxWidth: "960px", margin: "0 auto", padding: "48px 20px" }}
      >
        <h2
          style={{
            fontSize: "20px",
      ...
      >
        {[
          ...
          >
            <span
              style={{ color: "#1A7A4A", fontWeight: "700", fontSize: "14px" }}
            >
              {item.icon}
            </span>
