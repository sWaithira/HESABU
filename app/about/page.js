...
export const metadata = {
  title: "About",
  description:
    "Why Hesabu exists, who built it, and what it's trying to do for Kenyans.",
};
    ...
    >
      ...
      <div style={{ marginBottom: "48px" }}>
        ...
        <p style={{ fontSize: "16px", color: "#555", lineHeight: 1.7 }}>
          Hesabu turns complicated financial rules into simple numbers —
          instantly.
        </p>
      </div>
      ...
      <div style={{ marginBottom: "40px" }}>
        ...
        >
          <p>
            Hesabu started with a simple frustration: everyday financial
            calculations in Kenya are harder than they should be.
          </p>
          <p>
            In Kenya, understanding everyday financial costs often means digging
            through long PDFs, confusing fee tables or screenshots shared on
            WhatsApp. Whether it's calculating M-Pesa transaction fees,
            understanding salary deductions or estimating loan repayments — the
            information exists, but it's not easy to use.
          </p>
          <p>
            I built Hesabu to turn those complicated rules into simple tools.
            Instead of reading through pages of conditions, you enter a number
            and immediately see the result.
          </p>
          <p style={{ fontWeight: "600", color: "#0D4A2E" }}>
            Because understanding your money shouldn't feel like solving a
            puzzle.
          </p>
        </div>
      </div>
      ...
      <div style={{ marginBottom: "40px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {[
            {
              emoji: <i className="fa-solid fa-mobile-screen"></i>,
              title: "Calculate M-Pesa fees",
              desc: "Know exactly what Safaricom charges before you send or withdraw — no surprises.",
            },
            {
              emoji: <i className="fa-solid fa-credit-card"></i>,
              title: "Understand Fuliza costs",
              desc: "Find out what borrowing via Fuliza will actually cost you over time.",
            },
            {
              emoji: <i className="fa-solid fa-coins"></i>,
              title: "Break down your salary",
              desc: "See your gross salary split into PAYE, NHIF, NSSF, housing levy — and your net pay.",
            },
            {
              emoji: <i className="fa-solid fa-building"></i>,
              title: "Estimate loan repayments",
              desc: "Are you a micro-lender or part of an organization like SACCOs or loan providers? Let us transform your manual frustrations into digital solutions. Reach out to be part of the transformation.",
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <div style={{ marginBottom: "40px" }}>
        ...
        >
          ...
          <div>
            <div
              style={{ fontWeight: "700", color: "#0D4A2E", fontSize: "16px" }}
            >
              Susan Nyawira
            </div>
        ...
        >
          ...
          <p>
            My interests include backend systems, web development and
            cybersecurity. Lately I've been exploring how small web applications
